...
CREATE TABLE IF NOT EXISTS AppStatus (
    AppStatusID INT(2) NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS Education(
    EducationID INT(5) NOT NULL UNIQUE AUTO_INCREMENT,
    Title VARCHAR(255) NOT NULL,
    Time_Stamp DATETIME NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS Roles (
    RoleID INT(5) NOT NULL UNIQUE AUTO_INCREMENT,
    Title VARCHAR(255) NOT NULL,
    Time_Stamp DATETIME NOT NULL DEFAULT NOW(),
    PRIMARY KEY (RoleID)
);
...
CREATE TABLE IF NOT EXISTS ExpReq (
    ExpReqID INT(2) NOT NULL AUTO_INCREMENT,
    Title VARCHAR(255) NOT NULL,
    Time_Stamp DATETIME NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS Employee (
    EmployeeID INT(10) NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS JobPosts (
    ...
    JobResp TEXT DEFAULT NULL,
    JobQual TEXT DEFAULT NULL,
